...
const MealDetailHeader = ({
  ...
  return <div className="bg-primary text-white px-4 py-3 flex items-center justify-between">
            ...
            <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  ...
                  <Button variant="destructive" onClick={handleDelete} className="bg-chow-downvote hover:bg-chow-downvote/90">
                    Delete
                  </Button>
                </DialogFooter>
              </DialogContent>
